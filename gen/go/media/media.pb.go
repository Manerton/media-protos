...
const file_media_media_proto_rawDesc = "" +
	...
	"\avisible\x18\x02 \x01(\bR\avisible2\x84\x01\n" +
	"\x05Media\x12;\n" +
...
var file_media_media_proto_depIdxs = []int32{
	...
	2, // 1: media.Media.DeleteFile:input_type -> media.DeleteFileRequest
	1, // 2: media.Media.GetUploadURL:output_type -> media.GetURLResponse
	3, // 3: media.Media.DeleteFile:output_type -> google.protobuf.Empty
